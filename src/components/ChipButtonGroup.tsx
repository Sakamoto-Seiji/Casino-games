  ...
  return (
    <div className="flex-col">
      ...
      <div className="flex items-center justify-between bg-input_bg rounded-md overflow-hidden input">
        <button
          className="text-white w-10 fill-[#FFF]  h-full"
          onClick={() => scroll("left")}
        >
          <svg
            fill="currentColor"
        ...
        <button
          className="text-white w-10 fill-[#FFF] bg-input_bg h-full"
...
export const ChipButton: React.FC<ChipButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center text-[#fff] rounded-full uppercase text-sm font-bold select-none input  shadow-slate-950  outline text-[#2c2c2ccc] ${
        selected
          ? "outline-[2px] outline-[#00be00]"
          : "outline-[2px] outline-[#0000004f]"
      }`}
      style={{
