    ...
    <>
      {Label === "crash" ? (
        <div
          ...
          className="w-9 px-2 cursor-pointer mt-1"
        >
          <div className="w-8 h-5">{/* <Icon icon={"HistoryIcon"} /> */}</div>
        </div>
      ) : (
        <button
          onClick={() => setOpenModal(true)}
      ...
      <Modal
        ...
        className=" animate-zoomIn bg-[#2d2d2d] max-w-[530px] w-svw rounded-md border-[2px] border-[#da9820]"
      >
        <div className=" p-3">
          ...
          <div className="flex flex-col">
            <div>
              ...
              <div className="flex justify-center items-center">
                <Button onClick={() => skip > 0 && setSkip(skip - 1)}>
                  Previeus
                </Button>
